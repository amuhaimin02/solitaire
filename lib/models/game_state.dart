...
// import 'services/gameplay_storage.dart';
//
...
//
//   final GameplayStorage gameplayStorage;
//
//   GameState(
//       {required this.rules,
//       required this.gameplayStorage,
//       this.canAutoPremove = false}) {
//     _resetStates();
//     _setupPiles();
...
//     _cards = PlayCards.fromGame(rules);
...
//       _hintedCards = null;
//
//       // rules.afterEachMove(move, cards);
//
...
//   }
//
//   void _saveHistoryToDisk() {
//     gameplayStorage.save(_history, rules);
//   }
// }
//
